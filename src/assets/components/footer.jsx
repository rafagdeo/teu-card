...
const footer = () => {
  return (
    <div>
      ...
      <div class="justify-between gap-4 flex flex-col md:grid grid-cols-4 md:space-x-6 py-8 md:flex-row lg:w-[1440px] lg:mx-auto">
        ...
        <div class="flex flex-col p-0 text-white space-x-0 gap-4 md:pl-24">
        ...
        <div class="flex flex-col md:pl-12 text-white gap-4">
